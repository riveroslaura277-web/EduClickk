...
namespace EduClick.Controllers
{
    ...
    {
        private static List<CursoViewModels> _datos = DatosPrueba.Cursos();
        ...
        [HttpPost]
        public IActionResult Agregar(CursoViewModels curso)
        {
        ...
        [HttpPost]
        public IActionResult Editar(CursoViewModels curso)
        {
